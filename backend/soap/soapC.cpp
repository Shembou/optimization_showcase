...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.139 2025-07-31 16:08:02 GMT")
...
{	(void)type;
	...
	case SOAP_TYPE_ns__subtract:
		return soap_in_ns__subtract(soap, tag, NULL, "ns:subtract");
	case SOAP_TYPE_ns__subtractResponse:
		return soap_in_ns__subtractResponse(soap, tag, NULL, "ns:subtractResponse");
	...
	*type = 0;
	...
	{	const char *t = soap->type;
		...
		{	*type = SOAP_TYPE_ns__subtract;
			return soap_in_ns__subtract(soap, tag, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "ns:subtractResponse"))
		{	*type = SOAP_TYPE_ns__subtractResponse;
			return soap_in_ns__subtractResponse(soap, tag, NULL, NULL);
		}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_fdelete(struct soap *soap, struct soap_clist *p)
{
	...
	case SOAP_TYPE_ns__subtractResponse:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<struct ns__subtractResponse*>(p->ptr), struct ns__subtractResponse);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<struct ns__subtractResponse*>(p->ptr), struct ns__subtractResponse);
		break;
	case SOAP_TYPE_ns__subtract:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<struct ns__subtract*>(p->ptr), struct ns__subtract);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<struct ns__subtract*>(p->ptr), struct ns__subtract);
		break;
#ifndef WITH_NOGLOBAL
	case SOAP_TYPE_SOAP_ENV__Header:
		if (p->size < 0)
...
SOAP_FMAC3 void SOAP_FMAC4 soap_finsert(struct soap *soap, int t, int tt, void *p, size_t index, const void *q, void **x)
{
	...
	case SOAP_TYPE_ns__add:
		...
		*(struct ns__add*)p = *(struct ns__add*)q;
		break;
	case SOAP_TYPE_ns__subtractResponse:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct ns__subtractResponse type=%d location=%p object=%p\n", t, p, q));
		*(struct ns__subtractResponse*)p = *(struct ns__subtractResponse*)q;
		break;
	case SOAP_TYPE_ns__subtract:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct ns__subtract type=%d location=%p object=%p\n", t, p, q));
...
SOAP_FMAC3 struct ns__subtract * SOAP_FMAC4 soap_in_ns__subtract(struct soap *soap, const char *tag, struct ns__subtract *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, NULL))
		return NULL;
	(void)type; /* appease -Wall -Werror */
	a = (struct ns__subtract*)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__subtract, sizeof(struct ns__subtract), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns__subtract *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__subtract, SOAP_TYPE_ns__subtract, sizeof(struct ns__subtract), 0, soap_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_ns__subtract(%p, %d, %s, %s)\n", (void*)soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct ns__subtract *p;
	size_t k = sizeof(struct ns__subtract);
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE_ns__subtract, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, struct ns__subtract);
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, struct ns__subtract, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct ns__subtract location=%p n=%d\n", (void*)p, n));
	if (size)
		*size = k;
	if (!p)
		soap->error = SOAP_EOM;
...
{
	if (soap_out_ns__subtract(soap, tag ? tag : "ns:subtract", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 struct ns__subtractResponse * SOAP_FMAC4 soap_in_ns__subtractResponse(struct soap *soap, const char *tag, struct ns__subtractResponse *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, NULL))
		return NULL;
	(void)type; /* appease -Wall -Werror */
	a = (struct ns__subtractResponse*)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__subtractResponse, sizeof(struct ns__subtractResponse), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns__subtractResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__subtractResponse, SOAP_TYPE_ns__subtractResponse, sizeof(struct ns__subtractResponse), 0, soap_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_ns__subtractResponse(%p, %d, %s, %s)\n", (void*)soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct ns__subtractResponse *p;
	size_t k = sizeof(struct ns__subtractResponse);
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE_ns__subtractResponse, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, struct ns__subtractResponse);
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, struct ns__subtractResponse, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct ns__subtractResponse location=%p n=%d\n", (void*)p, n));
	if (size)
		*size = k;
	if (!p)
		soap->error = SOAP_EOM;
...
{
	if (soap_out_ns__subtractResponse(soap, tag ? tag : "ns:subtractResponse", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
