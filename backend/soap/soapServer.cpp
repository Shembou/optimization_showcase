...
SOAP_SOURCE_STAMP("@(#) soapServer.cpp ver 2.8.139 2025-07-31 16:08:02 GMT")
...
{	struct ns__subtract soap_tmp_ns__subtract;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_ns__subtractResponse(soap, &soap_tmp_ns__subtractResponse, "ns:subtractResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
