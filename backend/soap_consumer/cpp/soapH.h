...
#ifndef SOAP_TYPE_ns__subtract_DEFINED
#define SOAP_TYPE_ns__subtract_DEFINED
...
inline struct ns__subtract * soap_new_ns__subtract(struct soap *soap, int n = -1)
{
	return soap_instantiate_ns__subtract(soap, n, NULL, NULL, NULL);
}

inline struct ns__subtract * soap_new_req_ns__subtract(
	struct soap *soap,
	int a,
	int b)
{
	struct ns__subtract *_p = ::soap_new_ns__subtract(soap);
	if (_p)
	{	::soap_default_ns__subtract(soap, _p);
		_p->a = a;
		_p->b = b;
	}
	return _p;
...
inline struct ns__subtract * soap_new_set_ns__subtract(
	struct soap *soap,
	int a,
	int b)
{
...
inline int soap_write_ns__subtract(struct soap *soap, struct ns__subtract const*p)
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize_ns__subtract(soap, p), 0) || ::soap_put_ns__subtract(soap, p, "ns:subtract", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_ns__subtract(struct soap *soap, const char *URL, struct ns__subtract const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_ns__subtract(soap, p), 0) || ::soap_put_ns__subtract(soap, p, "ns:subtract", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_PATCH_ns__subtract(struct soap *soap, const char *URL, struct ns__subtract const*p)
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_ns__subtract(soap, p), 0) || ::soap_put_ns__subtract(soap, p, "ns:subtract", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send_ns__subtract(struct soap *soap, const char *URL, struct ns__subtract const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_ns__subtract(soap, p), 0) || ::soap_put_ns__subtract(soap, p, "ns:subtract", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
SOAP_FMAC3 struct ns__subtract * SOAP_FMAC4 soap_get_ns__subtract(struct soap*, struct ns__subtract *, const char*, const char*);

inline int soap_read_ns__subtract(struct soap *soap, struct ns__subtract *p)
{
	if (p)
	{	::soap_default_ns__subtract(soap, p);
		if (soap_begin_recv(soap) || ::soap_get_ns__subtract(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_GET_ns__subtract(struct soap *soap, const char *URL, struct ns__subtract *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns__subtract(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}

inline int soap_POST_recv_ns__subtract(struct soap *soap, struct ns__subtract *p)
{
	if (::soap_read_ns__subtract(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
#endif

#ifndef SOAP_TYPE_ns__subtractResponse_DEFINED
#define SOAP_TYPE_ns__subtractResponse_DEFINED
...
inline struct ns__subtractResponse * soap_new_ns__subtractResponse(struct soap *soap, int n = -1)
{
	return soap_instantiate_ns__subtractResponse(soap, n, NULL, NULL, NULL);
}

inline struct ns__subtractResponse * soap_new_req_ns__subtractResponse(
	struct soap *soap)
{
	struct ns__subtractResponse *_p = ::soap_new_ns__subtractResponse(soap);
	if (_p)
	{	::soap_default_ns__subtractResponse(soap, _p);
	}
	return _p;
}

inline struct ns__subtractResponse * soap_new_set_ns__subtractResponse(
	struct soap *soap,
	int *result)
{
	struct ns__subtractResponse *_p = ::soap_new_ns__subtractResponse(soap);
...
inline int soap_write_ns__subtractResponse(struct soap *soap, struct ns__subtractResponse const*p)
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize_ns__subtractResponse(soap, p), 0) || ::soap_put_ns__subtractResponse(soap, p, "ns:subtractResponse", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_ns__subtractResponse(struct soap *soap, const char *URL, struct ns__subtractResponse const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_ns__subtractResponse(soap, p), 0) || ::soap_put_ns__subtractResponse(soap, p, "ns:subtractResponse", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_PATCH_ns__subtractResponse(struct soap *soap, const char *URL, struct ns__subtractResponse const*p)
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_ns__subtractResponse(soap, p), 0) || ::soap_put_ns__subtractResponse(soap, p, "ns:subtractResponse", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send_ns__subtractResponse(struct soap *soap, const char *URL, struct ns__subtractResponse const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_ns__subtractResponse(soap, p), 0) || ::soap_put_ns__subtractResponse(soap, p, "ns:subtractResponse", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
inline int soap_read_ns__subtractResponse(struct soap *soap, struct ns__subtractResponse *p)
{
	if (p)
	{	::soap_default_ns__subtractResponse(soap, p);
		if (soap_begin_recv(soap) || ::soap_get_ns__subtractResponse(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_GET_ns__subtractResponse(struct soap *soap, const char *URL, struct ns__subtractResponse *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns__subtractResponse(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}

inline int soap_POST_recv_ns__subtractResponse(struct soap *soap, struct ns__subtractResponse *p)
{
	if (::soap_read_ns__subtractResponse(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
#endif
