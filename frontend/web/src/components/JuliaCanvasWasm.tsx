        ...
        const initWasm = () => {
            try {
                ...
                if (canvas) {
                    ...
                    wasm.draw_julia_set("canvas-julia",1000,1000,-0.15,0.65);
        ...
        <section className="grid max-w-full max-h-full">
            ...
            <div className="grid grid-cols-2">
                <div>
                    ...
                    {timestamp && <h3 className="text-3xl text-black">WASM bindgen Julia set execution time: {timestamp} ms</h3>}
                </div>
            </div>
        </section>
    )
...
export default JuliaCanvasWasm;